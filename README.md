...
**구동부:** Encoder DC Motor ×2 / Servo Motor (DS3120) / Motor Driver (MD20A) / PCA9685 PWM Driver
...
**④ 전원 분리**
- RPi5 전용 레귤레이터 / 서보·LiDAR 전용 레귤레이터로 계통 분리 → 전압 강하 및 노이즈 감소
